> Historical snapshot: this file preserves the detailed changelog as it appeared before the September 9 documentation cleanup. Status statements describe their original point in time; use the root [CHANGELOG](../../../CHANGELOG.md) for current release status.
...
- Added a [prioritized improvement roadmap](../../roadmap.md): selectable access
...
- README, onboarding guidance, photo credits, coverage inventory, and the
  [dated admission record](../../data/preserve-admission-2026-09-04.md) distinguish
...
- A concise [onboarding and troubleshooting guide](../../trail-onboarding.md).
...
- Validation required no interactive authentication, second account, live AI,
  or saved-result write. See the [migration and admission evidence](../../data/teton-expansion-2026-09-03.md).
...
- The [performance and code-efficiency audit](../validation/2026-09-02-performance-code-efficiency-audit.md)
